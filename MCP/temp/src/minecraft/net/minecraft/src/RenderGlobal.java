   ...
   public void func_72712_a() {
      if(this.field_72769_h != null) {
         ...
         for(int var9 = 0; var9 < this.field_72766_m; ++var9) {
            for(int var10 = 0; var10 < this.field_72763_n; ++var10) {
               for(int var6 = 0; var6 < this.field_72764_o; ++var6) {
                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9] = new WorldRenderer(this.field_72769_h, this.field_72762_a, var9 * 16, var10 * 16, var6 * 16, this.field_72778_p + var2);
                  if(this.field_72774_t) {
                     this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].field_78934_v = this.field_72775_s.get(var3);
                  }

                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].field_78935_u = false;
                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].field_78936_t = true;
                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].field_78927_l = true;
                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].field_78937_s = var3++;
                  this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9].func_78914_f();
                  this.field_72768_k[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9] = this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9];
                  this.field_72767_j.add(this.field_72765_l[(var6 * this.field_72763_n + var10) * this.field_72766_m + var9]);
                  var2 += 3;
               }
            }
         }
         ...
         if(this.field_72769_h != null) {
            EntityLiving var11 = this.field_72777_q.field_71451_h;
            if(var11 != null) {
               this.func_72722_c(MathHelper.func_76128_c(var11.field_70165_t), MathHelper.func_76128_c(var11.field_70163_u), MathHelper.func_76128_c(var11.field_70161_v));
               Arrays.sort(this.field_72768_k, new EntitySorter(var11));
            }
         }
